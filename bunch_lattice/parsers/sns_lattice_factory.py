        ...
        for seq_da in accSeq_da_arr:
            ...
            for node_da in node_da_arr:
                ...
                # ------------BEND-----------------
                    ...
                    if (
                        params_da.hasAttribute("aperture_x")
                ...
                # ------------RF_Gap-----------------
                    ...
                    accNode.setParam("gap_phase", params_da.doubleValue("phase") * math.pi / 180.0)
            ...
            if math.fabs(firstNode.getLength() / 2.0 - firstNode.getParam("pos")) > self.zeroDistance:
                if firstNode.getLength() / 2.0 > firstNode.getParam("pos"):
                    ...
                    for idrift in range(nDrifts):
                        ...
                        drift.setParam("pos", 0.0 + drift.getLength() * (idrift + 0.5))
            ...
            for node_ind in range(len(copyAccNodes) - 1):
                ...
                if dist < 0.0:
                    ...
                    msg = (
                        ...
                        + accNode0.getName()
                        + " pos="
                        + str(accNode0.getParam("pos"))
                        + " L="
                        + str(accNode0.getLength())
                    )
                    msg = msg + os.linesep
                    msg = (
                        msg
                        ...
                        + accNode1.getName()
                        + " pos="
                        + str(accNode1.getParam("pos"))
                        + " L="
                        + str(accNode1.getLength())
                    )
                    msg = msg + os.linesep
                    orbitFinalize(msg)
