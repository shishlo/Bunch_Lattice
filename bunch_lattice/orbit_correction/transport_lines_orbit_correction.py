...
class TrajectoryCorrection:
    ...
    def correctTrajectory(self, bunch_initial):
        ...
        horResponceMtrxTr = horResponceMtrx.transpose()
        verResponceMtrxTr = verResponceMtrx.transpose()
    ...
    def calculateTrajectory(self, bunch_init, print_info=False):
        ...
        if print_info:
            ...
            for ind in range(len(bpm_value_hor_arr)):
                hor_val = bpm_value_hor_arr[ind] * 1000.0
                ver_val = bpm_value_ver_arr[ind] * 1000.0
